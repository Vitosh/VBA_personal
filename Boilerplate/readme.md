...
Simply download it and use it! Or go through the files in [https://github.com/Vitosh/VBA_personal/tree/master/Boilerplate/Boilerplate%20VitoshAcademy](boilerplate folder) and check them 1 by 1. If you find something interesting, copy it to your project.
